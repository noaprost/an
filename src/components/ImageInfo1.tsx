    ...
    <section className="mt-96 text-3xl flex flex-col items-center gap-20">
      <div className="flex justify-center items-center gap-20">
        <div className="flex flex-col items-center gap-3">
          <p>기존 영상을 업로드 하고</p>
          <div className="w-72 h-48 border-4 border-neutral-400 rounded-xl flex justify-center items-center bg-amber-100">
            <PlusCircleIcon />
          </div>
        ...
        <div className="flex flex-col items-center gap-3">
          <p>풀영상을 업로드 하면</p>
          <div className="w-72 h-48 border-4 border-neutral-400 rounded-xl flex justify-center items-center bg-blue-100">
            <PlusCircleIcon />
          </div>
