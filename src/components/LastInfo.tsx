...
export default function LastInfo() {
  ...
  return (
    <section className="lg:text-5xl md:text-5xl text-3xl flex flex-col items-center lg:py-72 md:py-72 py-80">
      <div>
        <div className={`${scroll && "animate-fade-in-up"}`}>
          <p>이처럼 단 두 단계의 과정으로</p>
          <p className="mt-3 text-blue-500">누구나 쉽고, 빠르게</p>
        </div>
        <p className={`lg:mt-24 md:mt:24 mt-16 ${scroll2 && "animate-fade-in-up"}`}>
